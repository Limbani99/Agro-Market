            ...
            <div className="container mx-auto px-4 py-16 lg:py-24 relative z-10">
                <div className="max-w-3xl">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 p-2 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl">
                        ...
                        <button className="bg-primary hover:bg-primary-dark text-white px-8 py-4 rounded-2xl font-bold transition-all shadow-lg shadow-primary/20 active:scale-95">
                            Search Now
                        </button>
                    </div>
